...
def argument_parsing():
	...
	parser.add_argument("beta_min", type = float, help = "minimun value to inverse temperature")
	parser.add_argument("beta_max", type = float, help = "maximun value to inverse temperature")
	parser.add_argument("delta_beta", type = float, help = "step value to inverse temperature")
	...
	parser.add_argument("-Nf", type = int,#
		help = "stops the simulation when the number of particles falls below NF. Default NF=0", default=0)
	parser.add_argument("--log",#
		help="sets the log level. Default=INFO. DEBUG will print detailed output of the simulation", default="INFO")
	return parser.parse_args()

def build_filenamebase(args, beta):
	...
	args_dict = {'N': args.N, 'Niter': args.Niter, 'Nsim': args.Nsim, 'Nsimst': args.Nsimst,#
		'beta': beta, 'dt': args.dt, 'lf': args.lf, 'stf': args.stf}
